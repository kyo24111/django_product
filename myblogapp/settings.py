...
SECRET_KEY = 'vc+k&-6-lcx!gpf7iwv6x1y&+p)=pawpdea6h0ixlg#n0!1*px'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
#ここを変更すると、アクセス権限を広げられる
...
INSTALLED_APPS = [
    ...
    # ↑の一行を追加することで作成したアプリケーションを呼び出せるようになった=ローカルアプリケーションの追加
    # ここの編集は大きく分けて2つしかない。残りの1つはサードパーティのライブラリをインストールしたら追加
]
